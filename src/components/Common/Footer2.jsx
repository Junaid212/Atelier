...
var bnr = require('./../../images/background/footerbg.webp');
                            ...
                            <div className="row">
                                        ...
                                        <div className="widget-post-bx">
                                            <div className="widget-post clearfix">
                                                ...
                                                <div className="sx-post-info">
                                                    <div className="sx-post-header">
                                                        <h6 className="post-title"><NavLink to={"/blog-single"}>New Collection Launch</NavLink></h6>
                                                    </div>
                                            ...
                                            <div className="widget-post clearfix">
                                                <div className="sx-post-date text-center text-uppercase text-white">
                                                    ...
                                                    <span className="p-month">Aug</span>
                                                    <span className="p-year">2025</span>
                                                </div>
                                                <div className="sx-post-info">
                                                    <div className="sx-post-header">
                                                        <h6 className="post-title"><NavLink to={"/blog-single"}>Wellness Interiors Showcase</NavLink></h6>
                                                    </div>
                                                    <div className="sx-post-meta">
                                                        <ul>
                                                            <li className="post-author"><i className="fa fa-user" />By Admin</li>
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6">
                                    <div className="widget widget_address_outer">
                                        <h5 className="widget-title">Let’s Talk</h5>
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="sx-footer-bot-left">
                                    <span className="copyrights-text">© 2019 Your Company. Designed By Atalier.</span>
                                </div>
                            </div>
                        </div>
                    </div>
